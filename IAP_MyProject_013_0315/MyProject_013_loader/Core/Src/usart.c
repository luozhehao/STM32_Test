...
//uint8_t USART_RX_BUF[USART_REC_LEN] __attribute__ ((at(0X20001000)));//接收缓冲,�??大USART_REC_LEN个字�??,起始地址�??0X20001000.
//uint8_t USART_RX_BUF[USART_REC_LEN] __attribute__ ((section(".RAM_Array")));//接收缓冲,�??大USART_REC_LEN个字�??,起始地址�??0X20001000.


// __attribute__((section("._Text_Area"))) uint8_t USART_RX_BUF[USART_REC_LEN];

CCMRAM uint8_t USART_RX_BUF[USART_RX_LEN];
SRAM uint8_t USART_REC_BUF[USART_REC_LEN];
